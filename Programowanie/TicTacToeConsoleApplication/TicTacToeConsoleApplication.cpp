...
bool isNotWinInRow(char board[], int rowCount, int colCount, char playerSign, int rowToCheck)
{
...
bool isWinInRows(char board[], int rowCount, int colCount, char playerSign)
{
	...
	{
		if (isNotWinInRow(board, rowCount, colCount, playerSign, rowNumber))
			return true;
	}
	return false;
}

bool isNotWinInCol(char board[], int rowCount, int colCount, char playerSign, int colToCheck)
{
...
bool isWinInCols(char board[], int rowCount, int colCount, char playerSign)
{
	...
	{
		if (isNotWinInCol(board, rowCount, colCount, playerSign, colNumber))
			return true;
	}
	return false;
}
